...
export const metadata = {
  title: "Application Sample Preparation - Dawn Scientific",
  description:
    "Sample preparation is a critical step in laboratory analysis, ensuring accurate and reliable results across diverse applications.",
  ...
  twitter: {
    ...
    title: "Application Safety - Dawn Scientific",
    description:
      "Sample preparation is a critical step in laboratory analysis, ensuring accurate and reliable results across diverse applications.",
    images: [
