...
export const metadata = {
  title: "Application Liquid handling - Dawn Scientific",
  description:
    "In any laboratory, the task of liquid handling is significant for providing reliability in conducting experiments or analysis.",
  ...
  alternates: {
    canonical: "https://dawnscientific.com/application-liquid-handling",
  },
  ...
  openGraph: {
    ...
    description:
      "In any laboratory, the task of liquid handling is significant for providing reliability in conducting experiments or analysis.",
    url: "https://dawnscientific.com/application-liquid-handling",
