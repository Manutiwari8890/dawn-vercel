...
export async function generateMetadata({ params }) {
  ...
  const title =
    ...
    `${brandDetail?.data?.name} | Dawn Scientific`;
  ...
  return {
    ...
    keywords: brandDetail?.data?.meta_keyword || `${brandDetail?.data?.name}, ${brandDetail?.data?.slug}, Dawn Scientific`,

    alternates: {
      canonical: `https://www.dawnscientific.com/brand/${brandDetail?.data?.slug}`,
    },
    ...
    openGraph: {
      ...
      title,
      description,
      url: `https://www.dawnscientific.com/brand/${brandDetail?.data?.slug}`,
